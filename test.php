...
<html lang="en">
		...
		<header>
			...
			<div id="top-header">
				<div class="container">
					...
					<li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">: <?php echo $newResult["name"];?> <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="edit_profile.php"><font color="000000"> <span class="glyphicon glyphicon-cog"></span> แก้ไขข้อมูล</font></a></li>
            <li role="separator" class="divider"></li>
            <li><a href="logout.php"><font color="000000"> <span class="glyphicon glyphicon-log-out aria-hidden="true"></span> ออกจากระบบ</font></a></li>
          </ul>
        </li>
      </ul>
				</div>
  ...
  <div class="carousel-inner" role="listbox">
	...
	<img src="img/page007.jpg" alt="...">
      <div class="carousel-caption">
      </div>
    </div>
	<div class="item">
	<img src="img/page006.jpg" alt="...">
      <div class="carousel-caption">
	  </div>
    </div>
	  <div class="item">
	<img src="img/page004.jpg" alt="...">
      <div class="carousel-caption">
      </div>
    </div>
  </div>
...
<div class="modal fade" id="myModal1<?php echo $newResult['ProductID']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <font color="#f00"><h5>ราคาสินค้า:</font> <?php echo number_format($newResult['p_price'],0); ?> บาท</h5>
      </div>
      <div class="modal-footer">
