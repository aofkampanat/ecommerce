...
?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">รายงานสินค้า</h1> <button class="btn btn-outline-primary my-2 my-sm-0" type="submit">เพิ่มสินค้า</button>
...
?> 
                        ...
                        <td><?php echo $newResult["p_price"];?> บาท</td>
                        <td><center><?php echo $newResult["p_number"];?> ชิ้น</center></td>
                        <td><center><?php echo $newResult["sumQty"];?> ชิ้น</center></td>
                      </tr>
