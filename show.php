...
<table class="table table-striped">
  <tr>
    ...
    <td width="10"><div align="center">ลบ</div></td>
  </tr>
  ...
  for($i=0;$i<=(int)$_SESSION["intLine"];$i++)
  {
	  ...
	  <tr>
		...
		<td><div align="center"><a href="delete.php?Line=<?php echo $i;?>" class="btn btn-danger btn-xs">ลบ</a></div></td>
	  </tr>
	  <?php
	  }
  }
...
<div align="left">
  <button type="submit" class="btn btn-danger">ปรับปรุงราคา</button>   
</div>
<div align="right">
<h5>ราคารวม <?php echo number_format($SumTotal,2);?> บาท<br><br>
  ภาษี 7 %<?php echo number_format($ATotal,2);?> บาท<br><br>
  	รวมเป็นเงิน <?php echo number_format($AATotal,2);?> บาท
  </form>
</div>
<div align="center"><br>
  <br>
  <a href="product.php" class="btn btn-success"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> กลับไปเลือกสินค้า</a></a>
  <?php
	if($SumTotal > 0)
	{
?>
  | <a href="checkout.php" class="btn btn-info"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> สั่งซื้อ </a></div>
<?php
	}
?>
<?php
