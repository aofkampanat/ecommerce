...
?>  
						<div class="aside">
                            ...
                            while($newResult = mysql_fetch_array($newQuery))
                                  {
									?> 
								<div><a href="product.php?act=showbytype&t_id=<?php echo $newResult["t_id"];?>&name=<?php echo $newResult["t_name"];?>"><?php echo $newResult["t_name"];?>  (<?php echo $newResult["ptotal"];?>)<small></small></a>							
								</div>						
								<?php
                                  }
                ?>   
