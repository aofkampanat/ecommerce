...
?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">รายงานสินค้า</h1> <button class="btn btn-outline-primary my-2 my-sm-0" type="submit"data-toggle="modal" data-target="#myModal2">เพิ่มสินค้า</button>
...
?> 
                         <tr>
                        <td><a href="#"><?php echo $newResult["ProductID"];?></a></td>
                        <td><img src="img/product/<?= $newResult["p_img"];?>"width="150"></td>
                        <td><?php echo $newResult["p_name"];?></td>
                        <td><?php echo $newResult["p_detail"];?></td>
                        <td><?php echo $newResult["p_price"];?></td>
                        <td><a href="#" class="btn btn-sm btn-primary">แก้ไข</i></a></td>
                        <td><a href="JavaScript:if(confirm('Confirm Delete?') == true){window.location='deleteproduct.php?ProductID=<?php echo $newResult["ProductID"];?>';}">ลบ</a></td>
                      </tr>
