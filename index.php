                            ...
                            while($newResult = mysql_fetch_array($newQuery))
                                  {
								   ...
								   ?> 		
										...
										<form action="order.php" method="post">		
											...
											<input type="hidden" name="txtProductID" value="<?php echo $newResult["ProductID"];?>" size="2"> <input type="hidden" name="txtQty" value="1" >
											<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i>ใส่ตระกร้า</button>
											</div>
										</div>
										</form>
